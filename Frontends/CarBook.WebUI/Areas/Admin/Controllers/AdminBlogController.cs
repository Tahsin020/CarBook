...
public class AdminBlogController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var responseMessage = await client.GetAsync("https://localhost:7209/api/Blogs");
    ...
    public async Task<IActionResult> CreateBlog(CreateBlogDto createBlogDto)
    {
        ...
        var responseMessage = await client.PostAsync("https://localhost:7209/api/Blogs", stringContent);
        if (responseMessage.IsSuccessStatusCode)
        {
    ...
    public async Task<IActionResult> UpdateBlog(UpdateBlogDto updateBlogDto)
    {
        ...
        StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
        var responseMessage = await client.PutAsync("https://localhost:7209/api/Blogs/", stringContent);
        if (responseMessage.IsSuccessStatusCode)
        {
            return RedirectToAction("Index", "AdminBlog", new { area = "Admin" });
        }
